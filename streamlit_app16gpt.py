...
def display_chat_messages():
    ...
    for message in st.session_state.messages:
        ...
        with st.chat_message(message["role"], avatar=role_label):
...
def main():
    ...
    st.image("https://upload.wikimedia.org/wikipedia/commons/4/48/BLANK_ICON.svg", width=100)
    st.subheader("Groq Chat Streamlit App", divider="gray", anchor=False)
                        ...
                        <table style="width: 100%; margin-top: 10px;">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td style="text-align: left;">{speed:.2f}</td>
                                    <td style="text-align: left;">{speed:.2f}</td>
                                    <td style="text-align: left;">{speed:.2f}</td>
                                </tr>
                                <tr>
